...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pylint-venv-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12987&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pylint-venv-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pylint-venv` can be installed with:

```
conda install pylint-venv
```

It is possible to list all of the versions of `pylint-venv` available on your platform with:
